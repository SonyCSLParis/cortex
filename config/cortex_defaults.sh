...
: "${CORTEX_DEFAULT_TASKS_OPEN_STALE_DAYS:=14}"
: "${CORTEX_DEFAULT_TASKS_DOING_MAX_DAYS:=7}"
...
: "${CORTEX_DEFAULT_PUBLIC_COMMIT_NOTICE_TIMEOUT_SECONDS:=8}"
: "${CORTEX_DEFAULT_PUBLIC_COMMIT_NOTICE_MAX_COMMITS:=3}"
...
: "${CORTEX_DEFAULT_TIER_WEAK_CODEX_MODEL:=gpt-5.6-luna}"
: "${CORTEX_DEFAULT_TIER_WEAK_CLAUDE_MODEL:=claude-sonnet-4-6}"
: "${CORTEX_DEFAULT_TIER_WEAK_CODEX_REASONING:=medium}"
: "${CORTEX_DEFAULT_TIER_WEAK_CLAUDE_EFFORT:=low}"

: "${CORTEX_DEFAULT_TIER_MEDIUM_CODEX_MODEL:=gpt-5.6-terra}"
...
: "${CORTEX_DEFAULT_TIER_STRONG_CODEX_MODEL:=gpt-5.6-sol}"
...
export CORTEX_DEFAULT_TASKS_OPEN_STALE_DAYS
export CORTEX_DEFAULT_TASKS_DOING_MAX_DAYS
...
export CORTEX_DEFAULT_PUBLIC_COMMIT_NOTICE_TIMEOUT_SECONDS
export CORTEX_DEFAULT_PUBLIC_COMMIT_NOTICE_MAX_COMMITS
